const Footer = () => {
  return (
    <footer className="bg-[#101727] mt-30 text-white">
...
// <div className="pt-30">
//       <footer className="footer bg-[#101727] sm:footer-horizontal text-base-content p-10">
//         <div className="container text-white pt-30  px-10 mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
//           <div className="">
//             <h2 className="font-bold text-[36px] mb-4 ">DigiTools</h2>
//             <p>
//               Premium digital tools for creators,
//               <br /> professionals, and businesses. Work smarter <br /> with our
//               suite of powerful tools.
//             </p>
//           </div>
//          <div className="mr-12 grid grid-cols-1  md:grid-cols-3 lg:grid-cols-4  ">
